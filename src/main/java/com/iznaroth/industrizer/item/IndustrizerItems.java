...
public class IndustrizerItems {
    ...
    public static final RegistryObject<Item> LINK_TOOL = ITEMS.register("link_tool",
            () -> new LinkToolItem(new Item.Properties().tab(ModItemGroup.INDUSTRIZER_ITEMS)));
    ...
    public static final RegistryObject<Item> EVA_MUSIC_DISC = ITEMS.register("eva_music_disc",
            () -> new MusicDiscItem(4, ModSoundEvents.EVA_MUSIC_DISC, new Item.Properties().tab(ModItemGroup.INDUSTRIZER_ITEMS).stacksTo(1)));
