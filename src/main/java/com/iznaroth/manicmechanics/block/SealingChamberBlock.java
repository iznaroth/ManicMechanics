...
public class SealingChamberBlock extends Block {

    public SealingChamberBlock(AbstractBlock.Properties properties) {
        super(properties);
    }
    ...
    @Nullable
    @Override
    public TileEntity createTileEntity(BlockState state, IBlockReader world){ return new SealingChamberBlockTile(); }
    ...
    @Override
    public InteractionResult use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult trace) {
        if (!world.isClientSide) {
            TileEntity tileEntity = world.getBlockEntity(pos);
            if (tileEntity instanceof SealingChamberBlockTile) {
                INamedContainerProvider containerProvider = new INamedContainerProvider() {
                    ...
                    public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity) {
                        return new SealingChamberBlockContainer(i, world, pos, playerInventory, playerEntity);
                    }
                };
