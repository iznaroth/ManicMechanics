...
public class ClientSetup {
    ...
    public static void init(final FMLClientSetupEvent event) {
        ScreenManager.register(MMMenus.GENERATOR_CONTAINER.get(), GeneratorBlockScreen::new);

        ScreenManager.register(MMMenus.BUREAU_CONTAINER.get(), BureauBlockScreen::new);

        ScreenManager.register(MMMenus.COMMUNICATOR_CONTAINER.get(), CommunicatorBlockScreen::new);

        ScreenManager.register(MMMenus.SEALER_CONTAINER.get(), SealingChamberBlockScreen::new);

        ScreenManager.register(MMMenus.SIMPLE_COMMUNICATOR_CONTAINER.get(), SimpleCommunicatorBlockScreen::new);
    }
    ...
    public static void onClientSetupEvent(FMLClientSetupEvent event) {
        ...
        ClientRegistry.bindTileEntityRenderer(MMBlockEntities.RENDER_TESTER_TILE.get(), TileRendererRT::new);
