...
public class BlockRenderTester extends Block {
    ...
    @Override
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {return new TileRenderTester();}
    ...
    public void setPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (tileentity instanceof TileRenderTester) { // prevent a crash if not the right type, or is null
            TileRenderTester tileEntityMBE21 = (TileRenderTester)tileentity;
    ...
    public ActionResultType use(BlockState blockState, World world, BlockPos blockPos,
        ...
        if (tileentity instanceof TileRenderTester) { // prevent a crash if not the right type, or is null
            TileRenderTester tileEntityMBE21 = (TileRenderTester)tileentity;
            TileRenderTester.EnumRenderStyle renderStyle = tileEntityMBE21.getArtifactRenderStyle();
