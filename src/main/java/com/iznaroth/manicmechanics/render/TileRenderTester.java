...
public class TileRenderTester extends TileEntity {
    ...
    {
        super.save(parentNBTTagCompound); // The super call is required to save the tiles location
    ...
    {
        super.load(blockState, parentNBTTagCompound); // The super call is required to load the tiles location
