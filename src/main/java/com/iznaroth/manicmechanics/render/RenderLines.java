...
import com.iznaroth.manicmechanics.tools.RenderTypeHelper;
...
public class RenderLines  {
  ...
  public static void renderWireframe(TileRenderTester tileEntityMBE21, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffers,
