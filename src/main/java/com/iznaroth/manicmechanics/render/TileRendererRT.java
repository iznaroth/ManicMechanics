...
import static com.iznaroth.manicmechanics.render.RenderWavefrontObj.renderWavefrontObj;
...
public class TileRendererRT extends TileEntityRenderer<TileRenderTester> {
   ...
   */
  @Override
  public void render(TileRenderTester tileEntityMBE21, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffers,
                     int combinedLight, int combinedOverlay) {
    TileRenderTester.EnumRenderStyle objectRenderStyle = tileEntityMBE21.getArtifactRenderStyle();

    //System.out.println("This should be runnin' every frame.");
  ...
  @Override
  public boolean shouldRenderOffScreen(TileRenderTester tileEntityMBE21)
  {
    return false;
  }
