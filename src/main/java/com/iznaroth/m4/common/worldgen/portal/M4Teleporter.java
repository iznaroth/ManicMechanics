package com.iznaroth.m4.common.worldgen.portal;

import com.iznaroth.m4.common.block.PortalDeobfuscatorBlock;
...
public class M4Teleporter  {
    public static BlockPos thisPos = BlockPos.ZERO;
    public static boolean insideDimension = true;

    public M4Teleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destinationWorld.getBlockState(checkPos).getBlock() instanceof PortalDeobfuscatorBlock) {
                    doSetBlock = false;
                    break;
                }
            }
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, M4Blocks.PORTAL_DEOBFUSCATOR.get().defaultBlockState(), 3);
            }
        }
