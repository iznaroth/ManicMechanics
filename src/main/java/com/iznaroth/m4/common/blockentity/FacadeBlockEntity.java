...
public class FacadeBlockEntity {
    ...
    public FacadeBlockEntity(BlockPos pos, BlockState state) {
        //super(M4BlockEntities.FACADE_BLOCK_ENTITY.get(), pos, state);
    }
    ...
    public ClientboundBlockEntityDataPacket getUpdatePacket() {
        ...
        saveMimic(nbtTag);
        return ClientboundBlockEntityDataPacket.create(this, (BlockEntity entity, RegistryAccess access) -> {return nbtTag;});
    }
    ...
    public ModelData getModelData() {
        return ModelData.builder()
                .with(CableTubeBlock.FACADEID, mimicBlock)
                .build();
    }
